...
#[derive(Debug)]
pub struct FluxGazeProcessor {
    verbose: bool,
    processed_count: usize,
}

impl FluxGazeProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting FluxGaze processing");
    
    let mut processor = FluxGazeProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = FluxGazeProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = FluxGazeProcessor::new(false);
